...
const int g_nEvent = 1500000; // number of events per realization (and ExI in bExSpread)
const int g_nEvUpdate = g_nEvent / 10; // print progress to screen at this interval
...
const int g_nConEBin = 2000; // number of energy bins in constructed scheme
#else
...
const double g_dDelta = 3.20713; // effective energy due to pair breaking
  ...
  #ifdef bLD_CTM
    const double g_dTemp = 0.48473; // MeV 0.48473
    const double g_dE0 = -1.31817; // MeV -1.31817
...
//MARKER
const char popFile[] = "C:\\FAIRIES output\\ROOT_files\\createdPopFile.dat"; // made from TALYS "outpopulation y"
// make sure to match # of discrete bins. See ReadPopFile() bins + maxlevelstar + 1 = g_nExPopI
//MARKER
const int g_nExPopI = 2000; // bins 0-70; bins + maxlevelstar + 1 = g_nExPopI
const int g_nSpPopIBin = 10; // spins 0-9
//MARKER
const double g_dExRes = 0.003459879939969985; // excitation resolution on g_ah2ExEg
