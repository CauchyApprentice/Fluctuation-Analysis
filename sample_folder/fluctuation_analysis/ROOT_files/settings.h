...
const int g_nEvent = 1000000; // number of events per realization (and ExI in bExSpread)
...
//MARKER
const char popFile[] = "C:\\RAINIER\\sample_folder\\createdPopFile.dat"; // made from TALYS "outpopulation y"
